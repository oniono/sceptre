...
class SceptrePlan(object):
    ...
    def _execute(self, *args, reverse=False):
        launch_order = (list(reversed(self.launch_order))
                        if reverse else self.launch_order)
        executor = SceptrePlanExecutor(self.command, launch_order)
    ...
    def delete(self, *args):
        ...
        return self._execute(*args, reverse=True)
